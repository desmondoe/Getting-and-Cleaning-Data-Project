...
# setwd("./Desktop/Coursera.org/UCI HAR Dataset")
##########################################################################################################
...
## STEP FOUR: Appropriately label the data set with descriptive variable names correct column name
############
...
# STEP FIVE: Create a second, independent tidy data set with the average of each variable
# for each activity and each subject
#############

# 66 <- 68 columns but last two (activity & subject)
tiddy_data <- ddply(all_data, .(subject, activity), function(x) colMeans(x[, 1:66]))
